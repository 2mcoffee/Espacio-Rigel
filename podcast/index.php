...
<div class="text-center">
    <h1 class="main-title">#Podcast</h1>
</div>
<br>
<div class="container">
    <div>
    En esta sección vas a encontrar cada uno de nuestros podcast con sus respectivas guias de actividades, para que la descargues y trabajes con los temas de cada episodio.
    <div class="p-2"></div>
    Los días Viernes, de cada semana, subimos un nuevo episodio de "Espacio Rigel" a la plataforma de streaming Spotify.
    </div>
    <br>
